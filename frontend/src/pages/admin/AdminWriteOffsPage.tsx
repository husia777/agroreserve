// Списания товаров со склада — форма, таблица, аналитика
...
const WriteOffModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const createMut = useMutation({
    mutationFn: () => createWriteOff(form),
    onSuccess: () => {
      ...
      {showAnalytics && analytics && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            <h3 className="text-sm font-semibold text-gray-700 mb-4">По причинам</h3>
          ...
          {/* По товарам (bar) */}
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            <h3 className="text-sm font-semibold text-gray-700 mb-4">Топ товаров по убыткам</h3>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">Причина</th>
                  <th className="px-5 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">Убыток</th>
                </tr>
              </thead>
