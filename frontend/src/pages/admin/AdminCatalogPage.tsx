// Управление каталогом товаров в adminке
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      {isLoading ? (
        ...
        <EmptyState
          title="Товаров нет"
          action={{ label: 'Добавить товар', onClick: () => window.location.href = '/admin/catalog/new' }}
        />
      ) : (
        <>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="px-5 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">Опт</th>
                  <th className="px-5 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">Розница</th>
                  <th className="px-5 py-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider">Остаток</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {data?.items.map((product, i) => (
                  <tr key={product.id} className={i % 2 === 1 ? 'bg-gray-50/50' : ''}>
                    ...
                    <td className="px-5 py-3">
                      <div className="flex justify-center">
                        <button
                          onClick={() => toggleActiveMutation.mutate({ id: product.id, active: !product.is_active })}
