...
export const LoginPage: React.FC = () => {
	...
	const onSubmit = async (data: LoginFormData) => {
		try {
			...
			showToast.success(
				`Добро пожаловать, ${response.user.full_name.split(" ")[0]}!`,
			);
			...
			<div className="w-full max-w-md">
				...
				<div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
					...
					<a
						...
						className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl border-2 border-blue-200 text-blue-600 font-medium text-sm hover:bg-blue-50 transition-colors"
					>
