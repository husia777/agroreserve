...
export const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4 py-8">
      <div className="w-full max-w-lg">
        ...
        {isB2B && (
          <div className="mb-6 flex items-center gap-3">
            ...
            />
            <div className="whitespace-nowrap text-xs text-gray-500">Шаг {step} из 2</div>
          </div>
        )}
          ...
          {step === 2 && (
            <form onSubmit={handleStep2} className="space-y-4">
              ...
              <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3 text-sm text-yellow-800">
                После регистрации ваш аккаунт будет проверен менеджером. После одобрения вы получите
                доступ к оптовым ценам и заказам.
              </div>
