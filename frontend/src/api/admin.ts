...
export const updateProduct = async (
  ...
  const response = await apiClient.patch<Product>(`/admin/catalog/products/${productId}`, data)
  return response.data
}
...
export const updateCategory = async (
  ...
  const response = await apiClient.patch<Category>(`/admin/catalog/categories/${categoryId}`, data)
  return response.data
}
...
export const setCreditLimit = async (clientId: string, limit: number): Promise<User> => {
...
export const markDelivery = async (contractId: string, scheduleDate: string): Promise<Contract> => {
  const response = await apiClient.post<Contract>(`/admin/contracts/${contractId}/delivery`, {
    date: scheduleDate,
  })
  return response.data
}
...
export const getAnalyticsRevenue = async (params: {
  ...
  const response = await apiClient.get<AnalyticsRevenuePoint[]>('/admin/analytics/revenue', {
    params,
  })
  return response.data
}
...
export const getAnalyticsTopProducts = async (params: {
  ...
  const response = await apiClient.get<AnalyticsTopProduct[]>('/admin/analytics/products/top', {
    params,
  })
  return response.data
}
...
export const getAnalyticsTopClients = async (params: {
  ...
  const response = await apiClient.get<AnalyticsTopClient[]>('/admin/analytics/clients/top', {
    params,
  })
  return response.data
}
...
export const getAnalyticsTrends = async (params: {
  ...
  const response = await apiClient.get<AnalyticsRevenuePoint[]>('/admin/analytics/trends', {
    params,
  })
  return response.data
}
...
export const getClientCard = async (clientId: string): Promise<ClientCard> => {
  const response = await apiClient.get<ClientCard>(`/admin/crm/clients/${clientId}/card`)
  return response.data
}
...
export const getClientInteractions = async (
  clientId: string,
): Promise<{ _id: string; type: string; description: string; created_at: string }[]> => {
...
export const getReminders = async (params?: {
  ...
  const response = await apiClient.get<PaginatedResponse<ReminderV2>>('/admin/reminders', {
    params,
  })
  return response.data
}
...
export const getPriceLog = async (params?: {
  ...
  const response = await apiClient.get<PriceLogEntry[]>('/admin/procurement/price-logs', { params })
  return response.data
}
...
export const getRouteSheet = async (date: string): Promise<RouteSheet> => {
  const response = await apiClient.get<RouteSheet>('/admin/logistics/route-sheet', {
    params: { date },
  })
  return response.data
}
...
export const downloadRouteSheetPdf = async (date: string): Promise<{ file_url: string }> => {
  const response = await apiClient.post<{ file_url: string }>('/admin/logistics/route-sheet/pdf', {
    date,
  })
  return response.data
}
