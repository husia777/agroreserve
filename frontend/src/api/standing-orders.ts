...
export const createStandingOrder = async (
  ...
  const response = await apiClient.post<StandingOrder>('/standing-orders', data)
  return response.data
}
...
export const updateStandingOrder = async (
  ...
  const response = await apiClient.patch<StandingOrder>(`/standing-orders/${id}`, data)
  return response.data
}
...
export const toggleStandingOrder = async (
  ...
  const response = await apiClient.patch<StandingOrder>(`/standing-orders/${id}/toggle`, {
    is_active,
  })
  return response.data
}
