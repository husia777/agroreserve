...
class ExpenseCreate(BaseModel):
    ...
    def validate_category(cls, v: str) -> str:
        valid = ["rent", "transport", "packaging", "communication", "salary", "tax",
                 "bank", "insurance", "utilities", "marketing", "other"]
        if v not in valid:
...
class PnLPeriod(BaseModel):
    ...
    expenses_by_category: dict = Field(
        ...
        description="Расходы по категориям {'rent': 20000, 'transport': 15000, ...}"
    )
